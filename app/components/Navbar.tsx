    ...
    <nav className="flex justify-between items-center p-6 bg-gray-800 text-white sticky top-0 z-50">
      ...
      <ul className="flex gap-6 items-center">
        ...
        <li className="relative group">
          <button className="hover:text-purple-400 font-semibold">Event ▾</button>
          <ul className="absolute left-0 hidden group-hover:flex flex-col bg-gray-900 mt-2 rounded shadow-lg p-4 space-y-2 z-10 min-w-[180px]">
